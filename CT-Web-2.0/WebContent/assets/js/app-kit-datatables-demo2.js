angular.module('appKitDataTablesDemo',['ngResource','ngRoute','appKitCommon','appKit','datatables']);

angular.module('appKitDataTablesDemo').config(function($routeProvider) {
...
angular.module('appKitDataTablesDemo').factory('Skinny', function($resource) {
       return $resource('http://localhost:8080/CT-Web/patient/list/all/:type', { type: '@type' });
});

angular.module('appKitDataTablesDemo').factory('Trials', function($resource) {
	  return $resource('http://localhost:8080/CT-Web/study/list/read/');
});

angular.module('appKitDataTablesDemo').factory('Post', function($resource) {
	  return $resource('http://localhost:8080/CT-Web/patient/list/:type', { type: '@type' });
});

 angular.module('appKitDataTablesDemo').controller('AppKitDataTablesDemo', function($scope,  Skinny, Trials, Post, DTOptionsBuilder) {
	'use strict';
