...
public final class DemoAuthenticator {
	...
	private DemoAuthenticator() {
		 ...
		 */
		serviceKeysStorage.put("f80ebc87-ad5c-4b29-9366-5359768df5a1",
				"username1");
		serviceKeysStorage.put("3b91cab8-926f-49b6-ba00-920bcf934c2a",
				"username2");
	}
	...
	public String login(String serviceKey, String username, String password)
		...
		if (serviceKeysStorage.containsKey(serviceKey)) {
			...
			if (usernameMatch.equals(username)
	...
	public boolean isAuthTokenValid(String serviceKey, String authToken) {
		if (isServiceKeyValid(serviceKey)) {
			...
			if (authorizationTokensStorage.containsKey(authToken)) {
				String usernameMatch2 = authorizationTokensStorage
						.get(authToken);
